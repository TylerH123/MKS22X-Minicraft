...
## 6-4-19
### Tyler
Today, I worked on the player, testtile, and game class. I added a new key press, p. By pressing p while a station menu is displayed allows you to pickup the station. I also added comments to all the classes I worked on. For player class, I updated the punch so stones can only be broken by pickaxes. Trees can be broken by fist or axes. However, when punching with fists, the player loses health. Axes do twice as much damage to trees. For the testtile class, I added a way for the tile to be a tree. I also added a way for players to gain resources after breaking a tree or stone. After breaking a tree or stone, the resource will be automatically added into the inventory. Finally, I added the monster class. I worked on collision with the player. If it touches player, then player will take damage. The player can kill the monster by pressing p while touching the monster. 
